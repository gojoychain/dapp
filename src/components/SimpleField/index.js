...
const SimpleField = (props) => {
  const { title, handleChange, changeStateName, value, onClickFunc, buttonText, label, adornment ,helperText, secondInputLabel, secondInputChangeStateName } = props
  return (
    <Fragment>
      ...
      <Button variant='contained' color='primary' onClick={onClickFunc}>{buttonText} </Button>
  </Fragment>
  )
}
